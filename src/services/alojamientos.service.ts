...
import type { AccommodationType } from "@/lib/schemas/accommodation-type.schema";
...
interface ApiAlojamientosPopulares {
  ...
  results: Array<{
    id: number;
    nombre: string; // antes establishmentName
...
const mapApiToAccommodation = (apiData: ApiAlojamiento): Accommodation => {
  return {
    ...
    tipo: apiData.tipo, // ID del tipo de alojamiento
    categoria: undefined,
